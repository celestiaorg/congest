...
COMMAND="./go/bin/txsim .celestia-app/keyring-test --blob 4 --blob-amounts 1 --blob-sizes 1000000-1300001 --key-path .celestia-app --grpc-endpoint localhost:9090 --feegrant"
#COMMAND="tmux kill-session -t txsim-2"
